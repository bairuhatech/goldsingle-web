  ...
  return (
    <div className="Screen-box">
      ...
      <div className="ftscreen-fnt mx-2">
        <PageHeader text="About Next ME – UAE’s Leading Electronics Retailer" />
        <h3 className="border-bottom border-secondary pb-3">
          Next ME – Yes, Your Electronics Destination!
        </h3>
        <h5>TURNING A CONCEPT INTO A REALITY</h5>
        <div className="d-flex p-2" style={{ textAlign: "justify" }}>
          Since its inception in 2005, Next ME has come a long way and achieved
        ...
        <div className="d-flex p-2" style={{ textAlign: "justify" }}>
          ...
          reputed international brands, Next ME’s distinctive style of enhancing
        ...
        <div className="d-flex p-2" style={{ textAlign: "justify" }}>
          ...
          Next ME assurance to customers which ensures that all product
          availability concerns are met with satisfactorily. Next ME ensures
          that the products are authorized to avoid any post purchase difficulty
          faced by customers. The Next ME ‘best price guarantee’ to customers is
          another highlight which ensures that customers get the best value for
          any product across all Next ME stores. In case of customer finding a
          product cheaper elsewhere, Next ME ensures that the price is matched.
          It strengthens customers’ trust in Next ME in delivering the best
          price in the market.
        </div>
        <h5>POSITIVE REINFORCEMENT </h5>
        <div className="d-flex p-2" style={{ textAlign: "justify" }}>
          Every month over 1 million customers visit our stores to make their
          purchases and enjoy the exceptional service and ambience that Next
          ME has become famous for. This is further reinforced by our customers’
          and vendors’ endorsement towards Next ME as their premier electronics
